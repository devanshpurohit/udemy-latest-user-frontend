...
const HeaderSecond = () => {
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        const forgotModal = window.bootstrap?.Modal?.getInstance(
          document.getElementById("htmlForgotPasswordModal"),
        );
        if (forgotModal) forgotModal.hide();
        const otpModal = new window.bootstrap.Modal(
          document.getElementById("otpEmailModal"),
        );
        otpModal.show();
      } else {
  ...
  const handleVerifyOtp = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        const setPasswordModal = new window.bootstrap.Modal(
    ...
    try {
      ...
      if (result.success) {
        ...
        const setPasswordModal =
          window.bootstrap?.Modal?.getInstance(setPasswordModalEl);
  ...
  return (
    <>
      ...
      <header
        className={`tp-header-section ${isSticky ? "tp-header-sticky" : ""}`}
      >
        <nav
          ref={headerRef}
        ...
        >
          <div className="container">
            ...
            {user && (
             <div
                ref={userDropdownRef}
                className="header-user dropdown tp-right-admin-details d-flex align-items-center d-lg-none"
            ...
            >
                ...
                >
                <div className="admn-icon me-1">
                    <img
                    src={
                        user?.profile?.profileImage &&
                        !user.profile.profileImage.includes("picsum.photos")
                ...
                <div className="profile-info me-1 mobile-responsive-bx">
                ...
                {userDropdownOpen && (
                <ul
                    className="dropdown-menu dropdown-menu-end user-dropdown sallr-drop-box hp-dropdown-box p-0 show"
                    style={{
                    position: "absolute",
                    top: "calc(100% + 5px)",
                    right: 0,
                ...
                >
                    ...
                    <li key={item.path} className="prescription-item">
                        <div
                ...
                {user ? (
                  <>
                    <div>
                      <NavLink
                        to="/add-cart"
                        className="nw-custom-btn nw-bell-btn position-relative"
                      >
                        <FaCartShopping />
                        {cartItems.length > 0 && (
                      ...
                      <div className="d-flex align-items-center gap-2 tp-right-admin-bx">
                        <div className="d-flex align-items-centet gap-2">
                          <div className="dropdown">
                            ...
                            <ul
                              className="dropdown-menu dropdown-menu-end notification-card p-0"
                              ...
                              <div className="notification-content custom-scrollbar">
                                {loadingAnnouncements ? (
                                  ...
                                  announcements.map((ann) => (
                                    <div
                                      key={ann._id}
                                      className="notification-parent-bx text-start"
                                    >
                                      <div>
                    ...
                    >
                      <a
                        ...
                        onClick={(e) => {
                          ...
                          e.stopPropagation();
                          console.log(
                            "👤 User dropdown clicked, current state:",
                            userDropdownOpen,
                          );
                      ...
                      >
                        <div className="admn-icon me-2">
                          {(() => {
                            ...
                            if (
                              !rawImage ||
                              rawImage.includes("picsum.photos")
                            ) {
                              return (
                      ...
                      <ul
                        className={`dropdown-menu dropdown-menu-end user-dropdown sallr-drop-box  hp-dropdown-box p-0 ${userDropdownOpen ? "show" : ""}`}
                        style={{
              ...
              <div className="row">
                ...
                <div className="col-lg-6">
                  <div className="text-end pe-3 pt-3">
                    <button
                      type="button"
                      className="modal-close-btn text-black fz-18"
                      ...
                      <form action="">
                        <div className="custom-frm-bx">
                          ...
                          <div className="pass-toggle-box">
                            <button type="button" className="pass-eye-btn">
                              {" "}
                          ...
                          <div className="d-flex align-items-start justify-content-between">
                            ...
                            <div className="">
                              <NavLink
                                ...
                                data-bs-toggle="modal"
                                data-bs-target="#htmlForgotPasswordModal"
                              >
                                Forgot Password?
                              </NavLink>
                            </div>
                ...
                <div className="col-lg-6">
                  ...
                  <div className="login-container">
                    <div className="login-header-content">
                      <div className="lg_sub_content">
                        <h4>
                          Register your AI Card and unlock a smarter way to
                          learn
                        </h4>
                      </div>
                      ...
                      <form action="">
                        ...
                        <div>
                          <span className="card-info-title">
                            <IoInformationCircle /> Check your AI Card for these
                            details.
                          </span>{" "}
                        </div>
                        ...
                        <div className="my-5">
                          <button
                            ...
                            className="nw-thm-btn w-100"
                            data-bs-toggle="modal"
                            data-bs-target="#registerProfile"
                          >
                            Continue
                          </button>
                        </div>
                        ...
                        <div className="udemy-tp-line">
                          <p>
                            Already registered your AI Card?{" "}
                            <a
                              href="#"
                              className="udemy-back-login"
                              data-bs-toggle="modal"
                  ...
                  <div className="login-container">
                    <div className="login-header-content">
                      ...
                      <form action="">
                        ...
                        <div className="text-center">
                          <span className="card-already-title">
                            Your AI Card is already registered. Log in to
                            continue.
                          </span>
                        </div>
                        ...
                        <div className="mt-5">
                          <div>
                            <button className="nw-thm-btn w-100 udemy-not-btn">
                              Continue
                            </button>
                          </div>

                          <div className="my-3 text-center">
                            <a href="#" className="card-back-btn">
                              Back
                            </a>
                          </div>
                        </div>
                        ...
                        <div className="udemy-tp-line">
                          <p>
                            Already registered your AI Card?{" "}
                            <a href="#" className="udemy-back-login">
                              Login
                            </a>{" "}
                          </p>
                        </div>
                        ...
                        <div className="row">
                          ...
                          <div className="udemy-tp-line border-top-0">
                            <p>
                              ...
                              <span className="resend-title">in 30s</span>{" "}
                            </p>
                          </div>
                        </div>
                      </form>
                  ...
                  <div className="login-container">
                    <div className="login-header-content">
                      <div className="lg_sub_content">
                        ...
                        <h4>
                          Create a username and password to securely access your
                          AI course.
                        </h4>
                      </div>
                          ...
                          <div className="udemy-tp-line border-top-0">
                            <p>
                              ...
                              <button
                                ...
                                className="udemy-back-login border-0 bg-transparent"
                              >
                                Resend
                              </button>{" "}
                            </p>
                ...
                <div className="col-lg-12">
                  <div className="logout-bx text-center">
                    ...
                    <div className="d-flex align-items-center gap-3 justify-content-center mt-3">
                      <button
                        className="thm-lg-dg-btn outline"
                        data-bs-dismiss="modal"
                        aria-label="Close"
                      >
                        Cancel
